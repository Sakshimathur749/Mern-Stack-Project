          ...
          >
            ...
            <div className="col-lg-6">
              ...
              <div className="row align-items-center">
                  <div className="d-none d-lg-block flex-wrap" >
                    <img src={Image1} alt="Image 1" className='my-3 mx-2' style={{ width: "46%"}} />
                    <img src={Image2} alt="Image 2" className='my-3 mx-2' style={{ width: "46%"}} />
                    <img src={Image3} alt="Image 3" className='my-3 mx-2' style={{ width: "46%" }} />
                    <img src={Image4} alt="Image 4" className='my-3 mx-2' style={{ width: "46%"}} />
                  </div>
