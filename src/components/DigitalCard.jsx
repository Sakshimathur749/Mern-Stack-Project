            ...
            <div className="col-lg-6 items-center" >
              <div className="work-images">
                <div className="row align-items-center">
                  <div className="d-none d-lg-block flexx-wrap">
                    <img src={Image1} className='my-3 mx-2' alt="Image 1" style={{ width: "46%"}} />
                    <img src={Image2} className='my-3 mx-2' alt="Image 2" style={{ width: "46%"}} />
                    <img src={Image3} className='my-3 mx-2' alt="Image 3" style={{ width: "46%" }} />
                    <img src={Image4} className='my-3 mx-2' alt="Image 4" style={{ width: "46%"}} />
                  </div>
                  <div className="d-block d-lg-none">
                    ...
                    >
                      <SwiperSlide className='items-center text-center'
                      >
                        <img src={Image1} />
                      </SwiperSlide>
                      <SwiperSlide className='items-center text-center'
                    ...
                    <div
                  className="custom-pagination py-2 text-center"
                ></div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="single-pricing-box">
                ...
                <div className="buttons text-center " >
                  <a
                    className="theme-btn1 m-0 d-block"
                    href="/"
                  >
                    Buy Now{" "}
                    <span>
